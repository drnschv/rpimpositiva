		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Doc. Impositiva",
									"targetURL": "#DocImpositiva-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DocImpositiva-display": {
								"semanticObject": "DocImpositiva",
								"action": "display",
								"description": "Doc. Impositiva",
								"title": "Doc. Impositiva",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=profertil.uimodue",
									"url": sap.ui.require.toUrl("profertil/uimodue")
								}
							}
						}
					}
